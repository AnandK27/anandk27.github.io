    ...
    handler: () => {
      ...
      handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/1-project/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/2-project/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/3-project/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/4-project-copy-2/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/6-project/";
            },},{id: "projects-clia-ai",
          title: 'Clia.ai',
          ...
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/IntroStyle/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%6E%6B%30%32%39@%75%63%73%64.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/AnandK27", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/anand-kumar-ucsd", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=84H5le8AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
